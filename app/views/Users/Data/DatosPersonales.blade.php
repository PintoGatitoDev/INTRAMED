<h2>Datos Personales {{ $rol}}</h2>
<div id="DivDatosP">
    <form action="/User/{{ $id_user }}/EditInfPersonal" method="POST" class="form_edit">
        <p>
    ...
    ?>
        <p>
            ...
            <div class="center"><span>Estado Civil: </span><div class="visible">{{ $data['estado_civil']}}</div></div>
