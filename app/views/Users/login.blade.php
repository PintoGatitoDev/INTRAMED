...
<section class="w3-section w3-center">
    <form action="/auth/login" method="post" class="w3-card-4 formulario w3-padding" id="Login">
        ...
        <label for="email" class="w3-left w3-margin-bottom">Correo electrónico</label>
        <input type="email" name="email" id="email" placeholder="example@example.com" class="w3-input">

        <label for="password" class="w3-left w3-margin-bottom w3-margin-top">Contraseña</label>
